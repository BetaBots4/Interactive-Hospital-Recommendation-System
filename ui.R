                  ...
                  tabPanel(title="Developers",
                           fluidRow(
                             wellPanel(style = "overflow-y:scroll; height: 600px; opacity: 0.9; background-color: #ffffff;",
                                       ...
                                       strong("Arcot Gayathri, gayathri.arcot2019@vitstudent.ac.in"), br(),
                                       strong("Doppalapudi Nikkitha, nikkitha2019@vitstudent.ac.in"), br(),
                                       strong("Padegela Nageshwari, nageshwari2019@vitstudent.ac.in")
                             ))))
...
## UI 
ui <- shinyUI(navbarPage(title = strong("Hospital Recommendation system"),
                         tab1,
                         tab2,
                         tab3
))
