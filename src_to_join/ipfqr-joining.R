...
ipfqr.df.1 <- read.csv("C:\\Users\\lenovo\\Downloads\\Hospital-Recommendation-System-master (1)\\Hospital-Recommendation-System-master\\data\\raw\\hospital_level_data\\IPFQR_FUH_QualityMeasures_Facility.csv")
ipfqr.df.2 <- read.csv("C:\\Users\\lenovo\\Downloads\\Hospital-Recommendation-System-master (1)\\Hospital-Recommendation-System-master\\data\\raw\\hospital_level_data\\IPFQR_QualityMeasures_Facility.csv")
...
write.csv(hospital.df, "C:\\Users\\lenovo\\OneDrive\\Desktop\\sem 7\\ipfqr.csv")
...
write.csv(analysis.df, "C:\\Users\\lenovo\\OneDrive\\Desktop\\sem 7\\ipfqr_summary_mean_median_sd.csv", row.names=FALSE)
