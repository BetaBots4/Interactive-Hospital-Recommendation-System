...
hvbp.raw.df.01 <- read.csv("C:\\Users\\lenovo\\Downloads\\Hospital-Recommendation-System-master (1)\\Hospital-Recommendation-System-master\\data\\raw\\hospital_level_data\\hvbp_safety_11_07_2017.csv", stringsAsFactors = FALSE)
hvbp.raw.df.02 <- read.csv("C:\\Users\\lenovo\\Downloads\\Hospital-Recommendation-System-master (1)\\Hospital-Recommendation-System-master\\data\\raw\\hospital_level_data\\hvbp_clinical_care_11_07_2017.csv", stringsAsFactors = FALSE)
...
write.csv(hospital.df, "C:\\Users\\lenovo\\OneDrive\\Desktop\\sem 7\\hvbp.csv", row.names=FALSE)
...
write.csv(analysis.df, "C:\\Users\\lenovo\\OneDrive\\Desktop\\sem 7\\hvbp_summary_mean_median_sd.csv", row.names=FALSE)
