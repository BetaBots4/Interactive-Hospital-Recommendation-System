...
complications.data <- read.csv("C:\\Users\\lenovo\\Downloads\\Hospital-Recommendation-System-master (1)\\Hospital-Recommendation-System-master\\data\\raw\\hospital_level_data\\complications_deathsHospital.csv", stringsAsFactors = FALSE) %>%
...
write.csv(final.complication.summary.df, "C:\\Users\\lenovo\\OneDrive\\Desktop\\sem 7\\complication_summary.csv", row.names = FALSE)
write.csv(unique.complications.details, "C:\\Users\\lenovo\\OneDrive\\Desktop\\sem 7\\complication_summary_Measureid_measurename.csv", row.names = FALSE)
