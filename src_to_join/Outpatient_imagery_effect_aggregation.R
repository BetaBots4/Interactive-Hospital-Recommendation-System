...
library(tidyverse)
outpatient_imagery_effect <- read.csv("C:\\Users\\lenovo\\Downloads\\Hospital-Recommendation-System-master (1)\\Hospital-Recommendation-System-master\\data\\raw\\hospital_level_data\\outpatient_imagery_effect.csv",stringsAsFactors = FALSE)
...
write_csv(unique.imagery_effect.details,"C:\\Users\\lenovo\\OneDrive\\Desktop\\sem 7\\coltable_imagery")
...
write.csv(outpatient_imagery_effect_summary, "C:\\Users\\lenovo\\OneDrive\\Desktop\\sem 7\\outpatient_imagery_effect_summary.csv", row.names = FALSE)
