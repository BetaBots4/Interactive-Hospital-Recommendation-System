...
infections.data <- read.csv("C:\\Users\\lenovo\\Downloads\\Hospital-Recommendation-System-master (1)\\Hospital-Recommendation-System-master\\data\\raw\\hospital_level_data\\heathcare_associated_infections.csv", stringsAsFactors = FALSE) %>% filter(Score != "Not Available")
...
write.csv(final.infection.complication.summary.df, "C:\\Users\\lenovo\\OneDrive\\Desktop\\sem 7\\infection_summary.csv", row.names = FALSE)
...
write.csv(unique.infection.complications.details, "C:\\Users\\lenovo\\OneDrive\\Desktop\\sem 7\\infection_summary_Measureid_measurename.csv", row.names = FALSE)
