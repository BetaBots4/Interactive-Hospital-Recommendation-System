...
library(tidyverse)
timely_effective_care <- read.csv("C:\\Users\\lenovo\\Downloads\\Hospital-Recommendation-System-master (1)\\Hospital-Recommendation-System-master\\data\\raw\\hospital_level_data\\timely_effective_care.csv",stringsAsFactors = FALSE)
...
write_csv(unique.effectivecare.details,"C:\\Users\\lenovo\\OneDrive\\Desktop\\sem 7\\coltable_effectivecare")
...
write.csv(timely_effective_care_summary, "C:\\Users\\lenovo\\OneDrive\\Desktop\\sem 7\\timely_effective_care_summary.csv", row.names = FALSE)
